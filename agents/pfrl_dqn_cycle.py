...
from agents.agent import IndependentAgent, Agent, IndependentAgent_CycleAct


class IDQN_cycle(IndependentAgent_CycleAct):
    def __init__(self, config, obs_act, map_name, thread_number):
        ...
        for key in obs_act:
            ...
            self.agents[key] = DQNAgent_cycle(config, act_space, model)


class DQNAgent_cycle(Agent):
